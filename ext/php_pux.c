...
PHP_MINIT_FUNCTION(pux) {
  ...
  REGISTER_LONG_CONSTANT("REQ_METHOD_GET", REQ_METHOD_GET, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("REQ_METHOD_POST", REQ_METHOD_POST, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("REQ_METHOD_DELETE", REQ_METHOD_DELETE, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("REQ_METHOD_PUT", REQ_METHOD_PUT, CONST_CS | CONST_PERSISTENT);
  return SUCCESS;
}
